...
| `item_type_id` | UUID | NO | - | FK → commission_item_types.id |
...
## 9. VISTAS DEL MÓDULO COMISIONES

### 9.1 vw_hc_penalties_summary
...
## 10. FUNCIONES DEL MÓDULO COMISIONES

### 10.1 user_has_commission_access()
...
### 10.5 compare_commission_scenarios()
